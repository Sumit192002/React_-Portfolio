    ...
    <>
      <div className="container about-page">
        <div className="text-zone">
          ...
          <p>
           I'm passionate about Web technologies. I love to learn new things. I thrive on staying ahead of the curve, mastering HTML5, CSS3, and JavaScript, and embracing frameworks like React and Vue.js.
          </p>
          <p align="LEFT">
